...
void Shakingtree::minimizeBasic(int _batch_size = 10)
{
	mapParameters();
...
void Shakingtree::minimizeBasicLarger(int _batch_size = 70)
{
	mapParameters();
...
void Shakingtree::minimizeComplex(size_t _EVALSIZE = 50)
{
	mapParameters();

	//PHASE 1 We compute the previous score
	size_t EVALSIZE = _EVALSIZE;
	srand(_total_iter);
